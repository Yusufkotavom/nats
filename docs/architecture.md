...
- Statistik dashboard lintas modul (`/dashboard`, `/sales/dashboard`, `/purchase/dashboard`, `/accounting/dashboard`) juga wajib tenant-scoped; seluruh agregasi KPI/tren/top-list/recent-list harus memfilter `companyId = activeCompanyId`.
